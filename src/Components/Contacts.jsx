...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/theBotNinja/',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/devansh-joshi-12a036234/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LeetCode',
    url: 'https://leetcode.com/u/thebotninja/',
    icon: (
  ...
  {
    name: 'CodeChef',
    url: 'https://www.codechef.com/users/thebotninja',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const Contact = () => {
  return (
    <section id='contact'
     style={{ backgroundImage: `url(${BgImg})` }} className="bg-cover bg-center bg-blend-multiply relative py-24 bg-neutral-800 text-white overflow-hidden">
      {/* Final Ambient Glows */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:devanshtechwork@gmail.com" className="group flex items-center gap-4 w-max">
